...
import com.mahdimalv.promptstash.data.sync.AndroidDropboxAuthorizationRedirectHandler
import com.mahdimalv.promptstash.data.sync.AndroidExternalUrlLauncher
import com.mahdimalv.promptstash.data.sync.AndroidSecureCredentialStore
    ...
    return synchronized(appContainerLock) {
        ...
        createAppContainer(
            databaseBuilder = Room.databaseBuilder<PromptDatabase>(
                context = appContext,
                name = appContext.getDatabasePath(com.mahdimalv.promptstash.data.local.PromptDatabaseFileName).absolutePath,
            ),
