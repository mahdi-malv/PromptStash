package com.mahdimalv.promptstash.ui.screens.settings
...
import com.mahdimalv.promptstash.data.settings.ThemePreference
import com.mahdimalv.promptstash.data.sync.RemoteType
import com.mahdimalv.promptstash.ui.platformViewModel
import com.mahdimalv.promptstash.ui.components.FloatingNavBar
import com.mahdimalv.promptstash.ui.navigation.Library
...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                "Choose how PromptStash should look on this device.",
...
private fun dropboxFootnote(uiState: SettingsUiState): String {
    ...
    return when {
        ...
        authState.isAuthorizing ->
            "Finish the Dropbox approval in your browser, then return to PromptStash."
        else ->
            "Connect Dropbox to sync through the app folder. PromptStash stores the auth session securely on this device, and you can remove access anytime."
    }
}
